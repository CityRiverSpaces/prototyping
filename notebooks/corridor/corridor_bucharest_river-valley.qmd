...
leaflet() |>
    ...
    addPolylines(data = corridor_edge_1_nodev |> get_geom_latlon(), color = "blue", weight = 15) |>
    addPolylines(data = corridor_edge_2_nodev |> get_geom_latlon(), color = "green", weight = 15)
```
